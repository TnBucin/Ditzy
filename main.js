...
console.log(anu)
if (anu.action == 'add') {
fkontakk = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6283136505591-1604595598@g.us' } : {})}, message: { "contactMessage":{"displayName": `${mdata.subject}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;Radit;;;\nFN:Radit\nitem1.TEL;waid=6289678418893:6289678418893\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}
...
Lexxy.sendMessage(mdata.id, masuk, MessageType.text, { quoted: fkontakk, thumbnail: fs.readFileSync('./gambar/fake.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Welcome To ${mdata.subject}`,body:"",mediaType:"2",thumbnail:buff,mediaUrl:`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcREHmmXN9tBNpaDnBf-rO3l4jK0z0d_ekxuMg&usqp=CAU`}}})
...
Lexxy.sendMessage(mdata.id, keluar, MessageType.text, { quoted: fkontakk, thumbnail: fs.readFileSync('./gambar/fake.jpg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Keluar Dari ${mdata.subject}`,body:"",mediaType:"2",thumbnail:buff,mediaUrl:`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcREHmmXN9tBNpaDnBf-rO3l4jK0z0d_ekxuMg&usqp=CAU`}}})
...
console.log('[ ! ]', `'${module}'`, 'DI Pantau Oleh Ditzy')
